...
class GpuProducer : public Producer,
                     public ProcDescriptorDelegate,
                     public Unwinder::Delegate {
 public:
  GpuProducer(ProcDescriptorGetter* proc_fd_getter,
               base::TaskRunner* task_runner);
  ~GpuProducer() override = default;
 ...
 private:
  ...
  base::WeakPtrFactory<GpuProducer> weak_factory_;  // keep last
};
