...
void DimensityProfilerCmd::SaveTraceIntoIncidentOrCrash() {
...
void DimensityProfilerCmd::ReportTraceToAndroidFrameworkOrCrash() {
...
// errors.
void DimensityProfilerCmd::SaveOutputToIncidentTraceOrCrash() {
...
// static
base::ScopedFile DimensityProfilerCmd::CreateUnlinkedTmpFile() {
