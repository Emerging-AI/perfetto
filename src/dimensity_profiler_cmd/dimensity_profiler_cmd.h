...
#ifndef SRC_DIMENSITY_PROFILER_CMD_DIMENSITY_PROFILER_CMD_H_
#define SRC_DIMENSITY_PROFILER_CMD_DIMENSITY_PROFILER_CMD_H_
...
class DimensityProfilerCmd : public Consumer {
 public:
  DimensityProfilerCmd();
  ~DimensityProfilerCmd() override;
 ...
 private:
  ...
  std::optional<RemoteWriter> remote_writer_;
  ...
  base::WeakPtrFactory<DimensityProfilerCmd> weak_factory_{this};

  bool tracing_finshed_ = false;

};

}  // namespace perfetto

#endif  // SRC_DIMENSITY_PROFILER_CMD_DIMENSITY_PROFILER_CMD_H_
